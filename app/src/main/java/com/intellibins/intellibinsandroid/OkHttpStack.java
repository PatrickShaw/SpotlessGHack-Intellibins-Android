...
/**
 * The OkHttp3 Stack required to allow Volley to use OkHttp3 rather than HttpUrlConnection.
 * Why OkHttp3? HttpUrlConnection doesn't support the PATCH method on certain devices.
 * OkHttp3 is also generally faster.
